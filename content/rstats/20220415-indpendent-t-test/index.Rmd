...
parametric <- memory_ability %>% 
  ggbetweenstats(x = gender, y = words,
                 type = "parametric") +
  labs(title = "Parametric test")

nonparametric <- memory_ability %>% 
  ggbetweenstats(x = gender, y = words,
                 type = "nonparametric") +
  labs(title = "Nonparametric test")

para_nonpara <- parametric | nonparametric
ggsave(plot = para_nonpara, filename = "featured1.jpg")
